...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      themeConfig: {
        nav: [
          { text: "Changelog", link: "/react/changelog" },
          { text: "Config", link: "/match" },
          { text: "React SDK", link: "/react" },
          { text: "API", link: "/api" },
          { text: "Example", link: "https://github.com/matchidai/demo" },
        ],
        sidebar: {
          "/": [
            {
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    {
                      text: "EVM-compatible Wallets",
                      link: "/features/#evm-compatible-wallets",
                    },
                    {
                      text: "Solana Wallets",
                      link: "/features/#solana-wallets",
                    },
                    {
                      text: "BTC Wallets",
                      link: "/features/#btc-wallets",
                    },
                    {
                      text: "TRON Wallets",
                      link: "/features/#tron-wallets",
                    },
                    {
                      text: "TON Wallets",
                      link: "/features/#ton-wallets",
                    },
                    {
                      text: "Google",
                    ...
                    {
                      text: "YouTube",
                      link: "/features/#youtube",
                    },
                    {
                      text: "Facebook",
                      link: "/features/#facebook",
                    },
                    {
                      text: "LinkedIn",
                      link: "/features/#linkedin",
                    },
                    {
                      text: "Upcoming Social Logins",
                      link: "/features/#upcoming-social-logins",
                    },
                    {
                      text: "TikTok",
                      link: "/features/#tiktok",
                    },
                    {
                      text: "Farcaster",
                      link: "/features/#farcaster",
                    },
                    {
                      text: "Gitcoin",
                      link: "/features/#gitcoin",
                    },
                  ],
                },
                {
            ...
            {
              text: "Migrating to MatchID",
              items: [
                {
                  text: "Telegram MiniApp",
                  link: "/migrate/telegramMiniApp.html",
                },
              ],
            },
            {
              text: "App WebView Auth",
              link: "/features/app-webview-auth.html",
              items: [
                {
                  text: "Android",
                  link: "/features/app-webview-auth.html#android",
                },
                {
                  text: "IOS",
                  link: "/features/app-webview-auth.html#ios",
                },
                {
                  text: "React Native",
                  link: "/features/app-webview-auth.html#react-native",
                },
                {
                  text: "Flutter",
                  link: "/features/app-webview-auth.html#flutter",
                },
              ],
            },
            {
          ...
          "/api/": [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "User bind list demo",
                  link: "/api/method/bindlistdemo",
                },
                {
                  text: "Get user auth info",
                  link: "/api/method/auth/verify",
                },
                {
                  text: "User auth info demo",
                  link: "/api/method/userauthinfodemo",
                },
              ],
            },
          ],
          "/react/": [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "useClient",
                  link: "/react/hooks/useClient",
                },
                {
                  text: "useReadContract",
                  link: "/react/hooks/useReadContract",
                },
                {
                  text: "useWriteContract",
                  link: "/react/hooks/useWriteContract",
                },
                {
                  text: "walletOpsDemo",
                  link: "/react/hooks/walletOpsDemo",
                },
                // {
                //   text: 'useEvmAAWallet',

...
export const toWebAuthnKey = async ({ passkeyName, passkeyServerUrl, rpID, webAuthnKey, mode = WebAuthnMode.Register, credentials = "include", passkeyServerHeaders = {} }) => {
    if (webAuthnKey) {
        return webAuthnKey;
    }
    let pubKey;
